define("widget/formSubmit/1.0.0/formSubmit-debug", [ "$-debug" ], function(require, exports, module) {
    var $ = require("$-debug"), body = "body";
    formSubmit = function(options) {
        ...
        if (options.param) {
            ...
            options.form = $('<form action="' + options.action + '" method="' + ((options.method + "").toLowerCase() == "post" ? "post" : "get") + '" target="tsh-ifm"></form>');
        ...
        ifm.appendTo(body).on("load", function() {
            if (typeof options.callback === "function") {
                var res = ifm.contents().text().replace(/^\s+|\s+$/gm, "");
                try {
                    res = $.parseJSON(res);
                } catch (e) {}
